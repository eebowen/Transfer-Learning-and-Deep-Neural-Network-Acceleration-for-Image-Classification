...
#     data_path, data_files = common.find_sample_data(description="Runs a ResNet152 on Cars dataset network with a TensorRT inference engine.", subfolder="cars_resnet152", find_files=["00001.jpg", "00002.jpg","00003.jpg","00004.jpg","00005.jpg", "00006.jpg", ModelData.MODEL_PATH, "cars_labels.txt"])
...
#     print(onnx_model_file)
    ...
    onnx_model_file = '/datasets/home/62/062/boz004/TensorRT-5.1.5.0/data/cars_restnet152/resnet152v1.onnx'
    with build_engine_onnx(onnx_model_file) as engine:
        with open('resnet152v1.engine', 'wb') as f:
