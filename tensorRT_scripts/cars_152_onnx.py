...
def main():
    ...
    data_path, data_files = common.find_sample_data(description="Runs a ResNet152 on Cars dataset network with a TensorRT inference engine.", subfolder="cars_restnet152", find_files=["00001.jpg", "00002.jpg","00003.jpg","00004.jpg","00005.jpg", "00006.jpg", ModelData.MODEL_PATH, "cars_labels.txt"])
